...
def iniciar_torre(message):
    ...
    partidas[user_id] = {
        ...
        "piso": 1,
        "arma_daño": 10,
        "pociones": progreso[user_id]["pociones"]
    }
...
def ver_guia(call):
    ...
    bot.send_message(call.message.chat.id,
        "📜 𝗚𝗨𝗜𝗔 𝗗𝗘 𝗟𝗔 𝗧𝗢𝗥𝗥𝗘\n\n"
        "⚔️ 𝗔𝗧𝗔𝗖𝗔𝗥 - Daño normal al monstruo\n"
        "🛡️ 𝗗𝗘𝗙𝗘𝗡𝗗𝗘𝗥 - Reduce daño recibido\n"
        "✨ 𝗠𝗔𝗚𝗜𝗔 - Daño masivo pero puede fallar\n"
        "💊 𝗣𝗢𝗖𝗜𝗢𝗡 - Recupera 50 de vida\n\n"
        "🏆 𝗢𝗕𝗝𝗘𝗧𝗜𝗩𝗢\n"
...
def iniciar_aventura(call):
    ...
    if user_id not in partidas:
        partidas[user_id] = {"vida": 100, "piso": 1, "arma_daño": 10, "pociones": progreso[user_id]["pociones"]}
